  ...
  function buildNavbar() {
    ...
    nav.innerHTML = `
      <div class="navbar-inner">
        <a href="${basePath}index.html" class="navbar-logo-link">
          <img src="${basePath}logo.png" alt="Alphaville Odontologia" class="navbar-logo" />
        </a>
    ...
    window.addEventListener('scroll', () => {
      ...
      if (scrollY > 400 && scrollY > lastScroll) {
